...
# Per-channel target counts
SEED_PLAN = {
    1: 200,   # 环球风光 — platform operated, high volume
    4: 250,   # 深夜树洞
    5: 200,   # 恋爱日记
    6: 250,   # 人间真实
    7: 150,   # 萌宠
...
async def main():
    ...
    # 环球风光=80% (visual channel), 萌宠=60%, others=30%
    IMAGE_RATIOS = {
        1: 0.8,   # 环球风光 — mostly visual
        4: 0.3,   # 深夜树洞
        5: 0.3,   # 恋爱日记
        6: 0.25,  # 人间真实
        7: 0.6,   # 萌宠 — visual channel
        8: 0.25,  # 校园
        9: 0.35,  # 沙雕日常
        10: 0.2,  # 我要搞钱
    }
