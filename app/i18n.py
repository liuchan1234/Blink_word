...
_T: dict[str, dict[str, str]] = {
    ...
    "group_stopped": {"zh": "⏹ 已暂停。发 /world 重新开始。", "en": "⏹ Stopped. Send /world to start again.", "ru": "⏹ Остановлено. Отправь /world, чтобы начать снова.", "id": "⏹ Dihentikan. Kirim /world untuk mulai lagi.", "pt": "⏹ Pausado. Envie /world para recomeçar."},
