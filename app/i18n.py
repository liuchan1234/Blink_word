...
_T: dict[str, dict[str, str]] = {
    ...
    "enter_content": {"zh": "📝 写下你的故事（10-500字）\n\n可以发送纯文字\n也可以发一张图+文字（请以图片添加说明的形式，一次性发送）。", "en": "📝 Write your story (10–500 chars)\n\nText only, or send a photo with a caption (attach the photo with your text as one message).", "ru": "📝 Напиши свою историю (10–500 символов)\n\nМожно текст или фото с подписью (отправь фото и текст одним сообщением).", "id": "📝 Tulis ceritamu (10–500 karakter)\n\nBisa teks aja, atau foto + teks (kirim foto dengan keterangan sekaligus).", "pt": "📝 Escreva sua história (10–500 chars)\n\nSó texto, ou manda uma foto com legenda (envie a foto com o texto de uma vez)."},
    ...
    "daily_post_limit": {"zh": "⏳ 你今天已经发了 10 条内容，明天再来吧～", "en": "⏳ You've hit today's limit of 10 posts. Come back tomorrow!", "ru": "⏳ Сегодня ты уже опубликовал 10 историй. Возвращайся завтра!", "id": "⏳ Kamu udah posting 10 kali hari ini. Balik lagi besok ya!", "pt": "⏳ Você já postou 10 histórias hoje. Volte amanhã!"},
    ...
    "team_header": {"zh": "👥 <b>我的邀请团队</b>\n共邀请 {count} 人 · 活跃 {active} 人", "en": "👥 <b>My Invite Team</b>\n{count} invited · {active} active", "ru": "👥 <b>Мои приглашённые</b>\n{count} чел. · активных: {active}", "id": "👥 <b>Tim Undanganku</b>\n{count} diundang · {active} aktif", "pt": "👥 <b>Meu Time</b>\n{count} convidados · {active} ativos"},
    ...
    "team_footer": {"zh": "👑 = 已开通会员 · ✅ = 活跃（≥20刷）· ⬜ = 未活跃", "en": "👑 = Premium · ✅ = Active (≥20 swipes) · ⬜ = Inactive", "ru": "👑 = Премиум · ✅ = Активен (≥20) · ⬜ = Неактивен", "id": "👑 = Premium · ✅ = Aktif (≥20) · ⬜ = Belum aktif", "pt": "👑 = Premium · ✅ = Ativo (≥20) · ⬜ = Inativo"},
