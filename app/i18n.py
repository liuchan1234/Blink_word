...
_T: dict[str, dict[str, str]] = {
    ...
    "enter_content": {"zh": "📝 写下你的故事（30-500字）\n\n可以发送纯文字\n也可以发一张图+文字（请以图片添加说明的形式，一次性发送）。", "en": "📝 Write your story (30–500 chars)\n\nText only, or send a photo with a caption (attach the photo with your text as one message).", "ru": "📝 Напиши свою историю (30–500 символов)\n\nМожно текст или фото с подписью (отправь фото и текст одним сообщением).", "id": "📝 Tulis ceritamu (30–500 karakter)\n\nBisa teks aja, atau foto + teks (kirim foto dengan keterangan sekaligus).", "pt": "📝 Escreva sua história (30–500 chars)\n\nSó texto, ou manda uma foto com legenda (envie a foto com o texto de uma vez)."},
